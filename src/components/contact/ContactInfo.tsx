...
const departments = [
  ...
  },
  {
    ...
    email: 'hello@kanonkode.com',
    handles: ['College / university onboarding', 'Curriculum integration support', 'Campus workshop scheduling', 'Faculty development requests'],
    color: '#14B8A6',
  ...
  },
  {
    ...
    handles: ['Job openings at Kanonkode', 'Internship applications', 'Career guidance requests', 'Speaker / event invitations'],
    color: '#8B5CF6',
