...
export default function AboutHero() {
  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden" style={{ background: '#0F172A' }}>
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-[1280px] flex-col px-6 pb-20 pt-[108px] lg:px-16">
        <div className="max-w-[780px]">
          <div className="about-hero-item mb-7 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/8 px-4 py-2 backdrop-blur-sm">
          ...
          <p className="about-hero-item mb-10 max-w-lg text-[17px] leading-[1.65] text-white/70">
            We help you go from beginner to job-ready with live learning, real projects, and expert mentorship.
          </p>

          <div className="about-hero-item mb-14 flex flex-wrap items-center gap-4">
            <Link
              href="/courses"
            ...
            <Link
              href="#story"
              className="rounded-xl border-[1.5px] border-white/25 bg-white/8 px-8 py-4 text-[16px] font-semibold text-white backdrop-blur-sm transition-all duration-200 hover:border-white/40 hover:bg-white/15"
            >
              View Programs
            </Link>
          </div>
        ...
        <div className="about-hero-item mt-auto flex w-full flex-wrap items-center gap-4 md:gap-6 lg:gap-8 rounded-2xl border border-transparent bg-transparent px-6 py-5">
          ...
          <div className="relative overflow-hidden rounded-2xl px-5 py-4 md:px-8 md:py-5">
            ...
            <div className="relative flex flex-wrap items-center justify-center gap-x-8 gap-y-4 lg:flex-nowrap lg:justify-between lg:gap-x-10">
              {[
                ...
                <span
                  key={logo.name}
                  className={`${logo.font} cursor-default whitespace-nowrap text-[18px] text-white/75 transition-colors duration-200 hover:text-white`}
                >
                  {logo.name}
                </span>
              ))}
